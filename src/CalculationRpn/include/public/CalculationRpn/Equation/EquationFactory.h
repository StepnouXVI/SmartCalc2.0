...
class EquationFactory {
 ...
 private:
  enum OperationType { Number, Function, OpenBracket, CloseBracket, X };
 ...
 private:
  ...
  shared_ptr<NumberOperation> _openBracket = make_shared<NumberOperation>(
      0, Priority::OpenBracket, Associativity::Left);
